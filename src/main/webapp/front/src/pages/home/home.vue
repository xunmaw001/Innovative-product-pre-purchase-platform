...
<div class="home-preview" :style='{"width":"1200px","margin":"0 auto","background":"none"}'>
	<el-row type="flex" :gutter="5" justify="center" style="width: 100%">
		...
		<el-col :span="3" v-if="queryIndex==0">
			<el-input v-model="chanpinxiangmuchanpinmingcheng" placeholder="产品名称"></el-input>
		</el-col>
		<el-col :span="3" v-if="queryIndex==0">
			<el-button type="primary" @click="search('chanpinxiangmu')">搜索</el-button>
		</el-col>
	</el-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryIndex: 0,
        chanpinxiangmuchanpinmingcheng: '',
        newsList: [],
    ...
    methods: {
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.chanpinxiangmuchanpinmingcheng) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.chanpinxiangmuchanpinmingcheng}});
        }
      },
		getNewsList() {
