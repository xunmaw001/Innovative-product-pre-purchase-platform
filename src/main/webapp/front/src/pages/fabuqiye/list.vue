...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"2px solid #a4d9b7","padding":"10px 0","margin":"10px 0 0 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>企业名称</div>
	  ...
	  <el-button v-if="isAuth('fabuqiye','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"10px","outline":"none","color":"#fff","borderRadius":"10px","background":"#55b44b","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/fabuqiyeAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"margin":"20px 0 0 0","flex":"1"}'>
		...
		<div class="list2 index-pv1" :style='{"border":"2px solid #a4d9b7","padding":"20px 0px 0 0px","overflow":"hidden","borderRadius":"8px","background":"#fff","width":"100%","height":"auto"}'>
			<div :style='{"cursor":"pointer","margin":"0 0 20px 2%","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","fontSize":"0","float":"left","height":"150px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"boxShadow":"8px 0px 0 rgba(146, 181, 164,.5)","borderColor":"rgba(146, 181, 164,.8)","objectFit":"cover","borderRadius":"10px 40px 40px 10px","borderWidth":"0 12px 0 0","width":"240px","borderStyle":"solid","float":"left","height":"100%"}' v-if="item.qiyetupian && item.qiyetupian.substr(0,4)=='http'" :src="item.qiyetupian" class="image" />
				<img :style='{"boxShadow":"8px 0px 0 rgba(146, 181, 164,.5)","borderColor":"rgba(146, 181, 164,.8)","objectFit":"cover","borderRadius":"10px 40px 40px 10px","borderWidth":"0 12px 0 0","width":"240px","borderStyle":"solid","float":"left","height":"100%"}' v-else :src="baseUrl + (item.qiyetupian?item.qiyetupian.split(',')[0]:'')" class="image" />
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.qiyemingcheng != '') searchWhere.qiyemingcheng = '%' + this.formSearch.qiyemingcheng + '%';
	      params['sfsh'] = '是';
        this.$http.get('fabuqiye/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/fabuqiyeDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
